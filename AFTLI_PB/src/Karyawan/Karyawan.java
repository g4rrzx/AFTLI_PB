...
public class Karyawan extends javax.swing.JFrame {
        ...
        try {
            ...
            while (rs.next()) {
                model.addRow(new Object[]{
                    ...
                    rs.getString("absen"),
                    rs.getString("jumlahabsen"),
                    rs.getString("tunjangan"),
                    rs.getString("jumlahgaji")
                });
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIK", "Nama Karyawan", "Jenis Kelamin", "Jabatan", "Absen", "Jumlah Absen", "Tunjangan", "Jumlah Gaji"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
         try {
            Connection conn = DatabaseConnection.connect();
            String sql = "UPDATE karyawan SET namakaryawan=?, jeniskelamin=?, jabatan=?, absen=?, jumlahabsen=?, tunjangan=?, jumlahgaji=? WHERE nik=?";
            PreparedStatement stmt = conn.prepareStatement(sql);
            stmt.setString(1,  jTextField1.getText().trim());
            stmt.setString(2,  jTextField2.getText().trim());
            stmt.setString(3,  jTextField3.getText().trim());
            ...
            stmt.setString(5, jTextField5.getText().trim());
            stmt.setString(6, jTextField6.getText().trim());
            stmt.setString(7, jTextField6.getText().trim());
            stmt.setString(8, jTextField8.getText().trim());
