...
public class Anggota extends javax.swing.JFrame {
    ...
    private void tampilkanDataAnggota() {
        try {
            ...
            model.addColumn("Tempat Tgl Lahir");
            model.addColumn("Jenis Kelamin");
            model.addColumn("Alamat");
            model.addColumn("Tgl Pendaftaran");
            model.addColumn("Berlaku Hingga");
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Tgl Pendaftaran");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIS", "Nama Siswa", "Tempat Tgl Lahir", "Jenis Kelamin", "Alamat", "Tgl Pendaftaran", "Berlaku Hingga", "Kelas"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            Connection conn = DatabaseConnection.connect();
            String sql = "UPDATE anggota SET namasiswa=?, tempattgllahir=?, jeniskelamin=?, alamat=?, tglpendaftaran=?, berlakuhingga=?, kelas=? WHERE nis=?";
            PreparedStatement stmt = conn.prepareStatement(sql);
            stmt.setString(1, jTextField1.getText().trim());
            stmt.setString(2, jTextField2.getText().trim());
            stmt.setString(3, jTextField3.getText().trim());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (konfirmasi == JOptionPane.YES_OPTION) {
            try {
                Connection conn = DatabaseConnection.connect();
                String sql = "DELETE FROM anggota WHERE nis=?";
                PreparedStatement stmt = conn.prepareStatement(sql);
                stmt.setString(1, jTextField1.getText().trim());
                stmt.executeUpdate();
